...
public:
	...
	TMap<uint32_t, uint64_t>                           IntCustomAttributeMap;                                    // 0x02C8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0318(0x0010) MISSED OFFSET
	bool                                               IsMovable;                                                // 0x0328(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsCheckVisAngle;                                          // 0x0329(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsFireSpreadingCalCenter;                                 // 0x032A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableState;                                             // 0x032B(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsDestructibleItem;                                      // 0x032C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseMeshMapping;                                          // 0x032D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7A];                                      // 0x032E(0x007A) MISSED OFFSET
	class UPhotonDestructibleMeshComponent*            CachedDestructComp;                                       // 0x03A8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UDamageableComponentBase*                    CachedDamageableComp;                                     // 0x03B0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class ASTExtraBaseCharacter*                       CachedCharacterOwner;                                     // 0x03B8(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	void GetIntCustomAttributeList(TArray<struct FIntAIAttribute>* OutIntCustomAttributeList);
...
{
public:
	TArray<EBPAIState>                                 AdditionalStates;                                         // 0x0060(0x0010) (Edit, ZeroConstructor)
	EMobHasAIStateLogic                                LogicOp;                                                  // 0x0070(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0071(0x0007) MISSED OFFSET
...
// Class AI.BTDecorator_TargetHasBuff
// 0x0040 (0x00A0 - 0x0060)
class UBTDecorator_TargetHasBuff : public UBTDecorator
{
public:
	struct FBlackboardKeySelector                      BBKTarget;                                                // 0x0060(0x0028) (Edit)
	TArray<int>                                        BuffIDs;                                                  // 0x0088(0x0010) (Edit, ZeroConstructor)
	bool                                               bRequireAll;                                              // 0x0098(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0099(0x0007) MISSED OFFSET
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.BTDecorator_TargetHasBuff");
		return pStaticClass;
	}
...
public:
	...
	bool                                               bForceUseAIControllerRotation;                            // 0x00D0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00D1(0x0003) MISSED OFFSET
	float                                              HitRateLerpSpeed;                                         // 0x00D4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLerpHitRate;                                          // 0x00D8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMissOnPurpose;                                           // 0x00D9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x00DA(0x0002) MISSED OFFSET
	float                                              ScaleForHitPart;                                          // 0x00DC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bStopShootingWhenCannotSee;                               // 0x00E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableShootProbabilityCompensate;                        // 0x00E1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x6];                                       // 0x00E2(0x0006) MISSED OFFSET
	class UCurveFloat*                                 LowSpeedScaleShootProbabilityCurve;                       // 0x00E8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebugLine;                                           // 0x00F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x00F1(0x0003) MISSED OFFSET
	float                                              LineLifeTime;                                             // 0x00F4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
// Class AI.BTService_FlyingTowerDefenseChooseEnemy
// 0x0058 (0x00D8 - 0x0080)
class UBTService_FlyingTowerDefenseChooseEnemy : public UBTService_FlyingChooseEnemy
{
public:
	float                                              SwitchBackThreshold;                                      // 0x0080(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HatredDecreaseSpeed;                                      // 0x0084(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FBlackboardKeySelector                      DefendTargetKey;                                          // 0x0088(0x0028) (Edit, BlueprintVisible)
	struct FBlackboardKeySelector                      AttackingPlayerFlagKey;                                   // 0x00B0(0x0028) (Edit, BlueprintVisible)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.BTService_FlyingTowerDefenseChooseEnemy");
		return pStaticClass;
	}
...
{
public:
	float                                              FocusPointOffset_TargetCrouch;                            // 0x0098(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FocusPointOffset_TargetProne;                             // 0x009C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FocusPointOffset_TargetStand;                             // 0x00A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00A4(0x0004) MISSED OFFSET
...
// Class AI.BTService_Mob_TowerDefenseChooseEnemy
// 0x0060 (0x0130 - 0x00D0)
class UBTService_Mob_TowerDefenseChooseEnemy : public UBTService_Mob_ChooseEnemy
{
public:
	bool                                               bEnableTowerDefenseTargeting;                             // 0x00D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00D1(0x0003) MISSED OFFSET
	float                                              SwitchToPlayerThreshold;                                  // 0x00D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SwitchBackThreshold;                                      // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x00DC(0x0004) MISSED OFFSET
	struct FBlackboardKeySelector                      DefendTargetKey;                                          // 0x00E0(0x0028) (Edit, BlueprintVisible)
	struct FBlackboardKeySelector                      AttackingPlayerFlagKey;                                   // 0x0108(0x0028) (Edit, BlueprintVisible)

	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class AI.BTService_Mob_TowerDefenseChooseEnemy");
		return pStaticClass;
	}
...
public:
	...
	bool                                               bUseNodeMemoryForBlockState;                              // 0x00CE(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x00CF(0x0001) MISSED OFFSET
...
// 0x0020 (0x7450 - 0x7430)
class AMercenaryAICharacterBase : public ASTExtraPlayerCharacter
{
public:
	bool                                               bShouldUseGameModeNetCullingDist;                         // 0x7430(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x7431(0x0003) MISSED OFFSET
	float                                              AttachedActorFoldWeaponMaxAngle;                          // 0x7434(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AttachedPlayerHeightOffset;                               // 0x7438(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     GrenadeThrowOffset;                                       // 0x743C(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x7448(0x0008) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x3C0];                                     // 0x0138(0x03C0) MISSED OFFSET
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x04F8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0548(0x0008) MISSED OFFSET
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x0550(0x0030)
	float                                              AirAttackTotalTime;                                       // 0x0580(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0584(0x0004) MISSED OFFSET
	class UAirAttackComponent*                         AirAttackComp;                                            // 0x0588(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FBRBaseGlobalGameState                      GlobalGameState;                                          // 0x0590(0x00F0)
	TArray<struct FSpecialZoneState>                   SpecialZones;                                             // 0x0680(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x70];                                      // 0x0690(0x0070) MISSED OFFSET
	TMap<uint32_t, int>                                CachePlayerRevivalTypes;                                  // 0x0700(0x0050) (ZeroConstructor)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x0750(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<uint32_t, struct FString>                     VoiceRoomInfoMap;                                         // 0x0758(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FString>                     VoiceServerURLMap;                                        // 0x07A8(0x0050) (ZeroConstructor)
	TMap<int, int>                                     ItemDurabilityMap;                                        // 0x07F8(0x0050) (ZeroConstructor)
	int                                                AirDropTag;                                               // 0x0848(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x084C(0x0004) MISSED OFFSET
	float                                              ProduceSoundInterval;                                     // 0x0850(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nCanJumpToSky;                                            // 0x0854(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nNewbieRealHiddenScore;                                   // 0x0858(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nNewbieMatchCount;                                        // 0x085C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nModGameType;                                             // 0x0860(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                OverrideMapID;                                            // 0x0864(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x50];                                      // 0x0868(0x0050) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.TeammateMLAITeamIDSet
	TArray<uint32_t>                                   SilentMLAIList;                                           // 0x08B8(0x0010) (ZeroConstructor)
	bool                                               WhitelistPlayerStatesSwitch;                              // 0x08C8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x7];                                       // 0x08C9(0x0007) MISSED OFFSET
	TArray<uint32_t>                                   PlayerWhitelist;                                          // 0x08D0(0x0010) (ZeroConstructor)
	TMap<class APawn*, class APawn*>                   PlayerWhiteMercenary2MasterMap;                           // 0x08E0(0x0050) (ZeroConstructor)
	bool                                               IncludesMasterTeammatesSwitch;                            // 0x0930(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x0931(0x0003) MISSED OFFSET
	float                                              MercenaryPerceptionDist;                                  // 0x0934(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              MasterPerceptionDist;                                     // 0x0938(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              UpdateMercenaryPlayerWhiteInterval;                       // 0x093C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x50];                                      // 0x0940(0x0050) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.AICheckVisibilityFilteredActors
	TArray<TWeakObjectPtr<class UAIPerceptionDynamicItemComponent>> CachedDynamicItemComponents;                              // 0x0990(0x0010) (ExportObject, ZeroConstructor)
	TArray<TWeakObjectPtr<class UAIPerceptionDynamicItemComponent>> CachedDestructibleItemComponents;                         // 0x09A0(0x0010) (ExportObject, ZeroConstructor)
	unsigned char                                      UnknownData10[0x58];                                      // 0x09B0(0x0058) MISSED OFFSET
	TArray<class ASpecialZoneActor*>                   CacheDynamicSpecialZone;                                  // 0x0A08(0x0010) (ZeroConstructor)
	TArray<class ASpecialZoneActor*>                   PendingUpdateSpecialZones;                                // 0x0A18(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData11[0x18];                                      // 0x0A28(0x0018) MISSED OFFSET
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x0A40(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x8];                                       // 0x0A48(0x0008) MISSED OFFSET
	class UDataTableProxy*                             ItemTable;                                                // 0x0A50(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	void SetStrAIAttribute(uint32_t InPlayerKey, uint32_t InAttributeID, const struct FString& InAttributeValue);
	...
	void GetCacheStrAIAttributes(uint32_t InPlayerKey, TArray<struct FStrAIAttribute>* StrAttributes);
	void GetCacheIntAIAttributes(uint32_t InPlayerKey, TArray<struct FIntAIAttribute>* IntAttributes);
...
public:
	...
	TMap<uint32_t, uint64_t>                           IntCustomAttributeMap;                                    // 0x05D0(0x0050) (ZeroConstructor)
	bool                                               IsDestructibleMesh;                                       // 0x0620(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsInstanced;                                              // 0x0621(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0622(0x0002) MISSED OFFSET
	int                                                InstancedMaxNum;                                          // 0x0624(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<struct FString, int>                          StaticMeshNameToType;                                     // 0x0628(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               CheckNearHaveAI;                                          // 0x0678(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0679(0x0003) MISSED OFFSET
	float                                              CheckAIDist;                                              // 0x067C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USpecialZoneShapeComponent*                  SpecialZoneShapeComponent;                                // 0x0680(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor*                                      CacheParentActor;                                         // 0x0688(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0690(0x0004) MISSED OFFSET
	uint32_t                                           ExtraState;                                               // 0x0694(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Health;                                                   // 0x0698(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsSpawnBTAINeedCheck;                                     // 0x069C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ESpecialZoneType                                   SpecialZoneType;                                          // 0x069D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0xA];                                       // 0x069E(0x000A) MISSED OFFSET
	class AAIWorldVolume*                              AIWorldVolume;                                            // 0x06A8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UInstancedStaticMeshComponent*               CacheInstancedMeshComp;                                   // 0x06B0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USTDestructionComponent*                     CacheDestructibleMeshComp;                                // 0x06B8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
