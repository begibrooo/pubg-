...
// Function BattleItemHandle_WeapAttachment.BattleItemHandle_WeapAttachment_C.CalculateEquipAccessoriesPriority
// (Public, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UBattleItemHandle_MainWeapon_C* Weapon                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UBattleItemHandleBase*   Accessories                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// int                            WeaponPriority                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// int                            OutPriority                    (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UBattleItemHandle_WeapAttachment_C::CalculateEquipAccessoriesPriority(class UBattleItemHandle_MainWeapon_C* Weapon, class UBattleItemHandleBase* Accessories, int WeaponPriority, int* OutPriority)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function BattleItemHandle_WeapAttachment.BattleItemHandle_WeapAttachment_C.CalculateEquipAccessoriesPriority");

	UBattleItemHandle_WeapAttachment_C_CalculateEquipAccessoriesPriority_Params params;
	params.Weapon = Weapon;
	params.Accessories = Accessories;
	params.WeaponPriority = WeaponPriority;
