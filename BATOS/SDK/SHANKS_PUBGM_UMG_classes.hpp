...
public:
	...
	struct FSlateColor                                 ColorAndOpacity;                                          // 0x0170(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0198(0x0010) (ZeroConstructor, InstancedReference)
	struct FSlateColor                                 SelectColorAndOpacity;                                    // 0x01A8(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FSlateColor                                 NoSelectColorAndOpacity;                                  // 0x01D0(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bHaveSelectColorAndOpacity;                               // 0x01F8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bIsSelected;                                              // 0x01F9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x01FA(0x0006) MISSED OFFSET
	struct FSlateFontInfo                              Font;                                                     // 0x0200(0x0058) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FVector2D                                   ShadowOffset;                                             // 0x0258(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FLinearColor                                ShadowColorAndOpacity;                                    // 0x0260(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	...
	bool                                               AutoEllipsisText;                                         // 0x0284(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bWrapWithInvalidationPanel;                               // 0x0285(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x12];                                      // 0x0286(0x0012) MISSED OFFSET
...
{
public:
	float                                              RTScale;                                                  // 0x0A20(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetSpace                                       Space;                                                    // 0x0A24(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetTimingPolicy                                TimingPolicy;                                             // 0x0A25(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0A26(0x0002) MISSED OFFSET
	class UClass*                                      WidgetClass;                                              // 0x0A28(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0A30(0x0008) (Edit, IsPlainOldData)
	bool                                               bManuallyRedraw;                                          // 0x0A38(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRedrawRequested;                                         // 0x0A39(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0A3A(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x0A3C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0A40(0x0008) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x0A48(0x0008) (IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0A50(0x0004) MISSED OFFSET
	bool                                               bDrawAtDesiredSize;                                       // 0x0A54(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0A55(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x0A58(0x0008) (Edit, IsPlainOldData)
	bool                                               bReceiveHardwareInput;                                    // 0x0A60(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindowFocusable;                                         // 0x0A61(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x6];                                       // 0x0A62(0x0006) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x0A68(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0A70(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x0A80(0x0010) (Edit, IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x0A90(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EWidgetBlendMode                                   BlendMode;                                                // 0x0A94(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsTwoSided;                                              // 0x0A95(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               TickWhenOffscreen;                                        // 0x0A96(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x1];                                       // 0x0A97(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x0A98(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData07[0x20];                                      // 0x0AA0(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x0AC0(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA;                                    // 0x0AC8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterialAA_OneSided;                           // 0x0AD0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x0AD8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x0AE0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x0AE8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x0AF0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x0AF8(0x0008) (ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x0B00(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x0B08(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x0B10(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bAddedToScreen;                                           // 0x0B18(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x0B19(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x6];                                       // 0x0B1A(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x0B20(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x0B28(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EWidgetGeometryMode                                GeometryMode;                                             // 0x0B2C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x3];                                       // 0x0B2D(0x0003) MISSED OFFSET
	float                                              CylinderArcAngle;                                         // 0x0B30(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x54];                                      // 0x0B34(0x0054) MISSED OFFSET
	bool                                               ForceDisableShareRT;                                      // 0x0B88(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FLinearColor                                ColorAndOpacity;                                          // 0x01F4(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0204(0x0004) MISSED OFFSET
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0208(0x0010) (ZeroConstructor, InstancedReference)
	struct FString                                     imageSrcPath;                                             // 0x0218(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FVector2D                                   ScalePivot;                                               // 0x0228(0x0008) (Edit, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x20];                                      // 0x0258(0x0020) MISSED OFFSET
	float                                              HitTestAreaRadius;                                        // 0x0278(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsEnhancedImage;                                         // 0x027C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsUseEnhancedHitTest;                                    // 0x027D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFixOverScale;                                            // 0x027E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bVersionImg;                                              // 0x027F(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenAlphaZero;                                  // 0x0280(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDontPaintWhenColorZero;                                  // 0x0281(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAsyncLoadImageAsset;                                     // 0x0282(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDisablePixelSnapping;                                    // 0x0283(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FEditableTextStyle                          WidgetStyle;                                              // 0x0168(0x02B0) (Edit, BlueprintVisible)
	class USlateWidgetStyleAsset*                      Style;                                                    // 0x0418(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            BackgroundImageSelected;                                  // 0x0420(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            BackgroundImageComposing;                                 // 0x0428(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class USlateBrushAsset*                            CaretImage;                                               // 0x0430(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FSlateFontInfo                              Font;                                                     // 0x0438(0x0058) (Deprecated)
	struct FSlateColor                                 ColorAndOpacity;                                          // 0x0490(0x0028) (Deprecated)
	bool                                               IsReadOnly;                                               // 0x04B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsPassword;                                               // 0x04B9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x04BA(0x0002) MISSED OFFSET
	float                                              MinimumDesiredWidth;                                      // 0x04BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsCaretMovedWhenGainFocus;                                // 0x04C0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextWhenFocused;                                 // 0x04C1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               RevertTextOnEscape;                                       // 0x04C2(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               ClearKeyboardFocusOnCommit;                               // 0x04C3(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               SelectAllTextOnCommit;                                    // 0x04C4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               AllowContextMenu;                                         // 0x04C5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EVirtualKeyboardType>                  KeyboardType;                                             // 0x04C6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x04C7(0x0001) MISSED OFFSET
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x04C8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly)
	bool                                               bVirtualKeyboardTriggerDirect;                            // 0x04CC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x04CD(0x0003) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x04D0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x04E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FTextBlockStyle                             WidgetStyle;                                              // 0x0180(0x0250) (Edit, BlueprintVisible)
	...
	struct FSlateFontInfo                              Font;                                                     // 0x03D8(0x0058) (Deprecated)
	bool                                               AllowContextMenu;                                         // 0x0430(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0431(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x0438(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0448(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0458(0x0010) MISSED OFFSET
	...
	void SetIsReadOnly(bool bReadOnly);
	void SetHintText(const struct FText& InText);
	void SetFont(const struct FSlateFontInfo& InNewFont);
	void SetActiveColorIndex(int InIndex);
	void ScrollToEnd();
