...
void UIMSDKHelper::LoadAdvertise(const struct FString& InAdvertiseUnitId, const struct FString& InExtraJson)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
...
// Function ClientNet.IMSDKHelper.IsChannelInstalled
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// struct FString                 InChannelId                    (Parm, ZeroConstructor)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool UIMSDKHelper::IsChannelInstalled(const struct FString& InChannelId)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function ClientNet.IMSDKHelper.IsChannelInstalled");

	UIMSDKHelper_IsChannelInstalled_Params params;
	params.InChannelId = InChannelId;
