...
// Class BlockyLuaCore.BlockyCustomCommand
// 0x0000 (0x0100 - 0x0100)
class UBlockyCustomCommand : public UBlockyCommand
{
public:
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class BlockyLuaCore.BlockyCustomCommand");
		return pStaticClass;
	}
...
public:
	...
	struct FScriptDelegate                             OnCallShortCutKey;                                        // 0x1500(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnUndoCustomCommand;                                      // 0x1510(0x0010) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData16[0x70];                                      // 0x1520(0x0070) MISSED OFFSET
	class UHotfixUtility*                              HotfixUtility;                                            // 0x1590(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x50];                                      // 0x1598(0x0050) MISSED OFFSET
