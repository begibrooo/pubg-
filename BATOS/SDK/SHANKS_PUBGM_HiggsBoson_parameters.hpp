...
struct UHiggsBosonComponent_RPC_Client_ShowSecurityAlertWindow_Params
{
	struct FString                                     StrProperty_2;                                            // (Parm, ZeroConstructor)
};

// Function HiggsBoson.HiggsBosonComponent.RPC_Client_ServerNameAck
struct UHiggsBosonComponent_RPC_Client_ServerNameAck_Params
{
};

// Function HiggsBoson.HiggsBosonComponent.RPC_Server_TellServerName
struct UHiggsBosonComponent_RPC_Server_TellServerName_Params
{
...
// Function HiggsBoson.HiggsBosonComponent.ControlPalmRest
struct UHiggsBosonComponent_ControlPalmRest_Params
{
	int                                                Switch;                                                   // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
};
