...
public:
	...
	TEnumAsByte<ECollisionEnabled>                     FragmentsCollisionEnabled;                                // 0x0CC8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<ECollisionEnabled>                     FragmentsCollisionEnabled;                                // 0x0E18(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EPhotonDestructibleAction>             DestructibleAction;                                       // 0x0278(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UseDefaultParameter : 1;                                  // 0x0279(0x0001) (Edit)
	TEnumAsByte<EPhotonCollisionType>                  FragmentCollisonType;                                     // 0x027A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EEffectType>                           EffectType;                                               // 0x0E44(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	TEnumAsByte<EEffectType>                           EffectType;                                               // 0x0BDC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
