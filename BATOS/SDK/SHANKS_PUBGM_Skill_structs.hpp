...
// ScriptStruct Skill.SkillLocationFilterContext
// 0x0010
struct FSkillLocationFilterContext
{
	class AActor*                                      OwnerPawn;                                                // 0x0000(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class AUTSkill*                                    OwnerSkill;                                               // 0x0008(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
