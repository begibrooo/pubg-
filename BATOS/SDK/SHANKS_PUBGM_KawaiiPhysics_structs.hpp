...
// Generate on Tue Sep  8 20:34:56 2026
...
struct FKawaiiPhysicsEdgeCollisionSettings
{
	...
	int                                                StripGroup;                                               // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bLoopStripGroup;                                          // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	int                                                TotalStripCount;                                          // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionTolerance;                                       // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDebugDrawInGame;                                         // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bActiveLateralConstraint;                                 // 0x0019(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x001A(0x0002) MISSED OFFSET
	int                                                LateralConstraintIterationCount;                          // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LateralConstraintWeight;                                  // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseDiagonalEdgesForLateralConstraint;                    // 0x0024(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ELateralConstraintMode                             LateralConstraintMode;                                    // 0x0025(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EComplianceType                                    ComplianceType;                                           // 0x0026(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x0027(0x0001) MISSED OFFSET
	float                                              ComplianceValueOverride;                                  // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FNewAnimNode_KawaiiPhysics : public FAnimNode_SkeletalControlBase
{
	...
	struct FKawaiiPhysicsEdgeCollisionSettings         EdgeCollisionSettings;                                    // 0x017C(0x002C) (Edit)
	bool                                               bEnableEndBoneControl;                                    // 0x01A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x01A9(0x0003) MISSED OFFSET
	struct FVector                                     EndBoneControlOffset;                                     // 0x01AC(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    EndBoneControlRotation;                                   // 0x01B8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     RootBoneControlOffset;                                    // 0x01C4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	TArray<struct FNewKawaiiPhysicsModifyBone>         ModifyBones;                                              // 0x01D0(0x0010) (ZeroConstructor)
	float                                              TotalBoneLength;                                          // 0x01E0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0xC];                                       // 0x01E4(0x000C) MISSED OFFSET
	struct FTransform                                  PreSkelCompTransform;                                     // 0x01F0(0x0030) (IsPlainOldData)
	bool                                               bInitPhysicsSettings;                                     // 0x0220(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x12F];                                     // 0x0221(0x012F) MISSED OFFSET
};
