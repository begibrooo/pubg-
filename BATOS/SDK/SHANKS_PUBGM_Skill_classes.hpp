...
public:
	...
	class UActorComponent*                             CurOwnerActorComponent;                                   // 0x07F0(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData07[0x4];                                       // 0x090C(0x0004) MISSED OFFSET
	TArray<struct FSkillParamater>                     SkillParamaters;                                          // 0x0910(0x0010) (Net, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSkillInitSignature;                                     // 0x0920(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    InitOneSkillEvent;                                        // 0x0930(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStartEvent;                                          // 0x0940(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillStopEvent;                                           // 0x0950(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillPhaseChangeEvent;                                    // 0x0960(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillLevelChangeEvent;                                    // 0x0970(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillSkinIDChangeEvent;                                   // 0x0980(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillDoCoolDownEvent;                                     // 0x0990(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    SkillUpdateCDEvent;                                       // 0x09A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TArray<int>                                        PendingRemoveSkillID;                                     // 0x09B0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x50];                                      // 0x09C0(0x0050) MISSED OFFSET
	TArray<struct FUTReplaceSkillData>                 ReplacedSkillDatas;                                       // 0x0A10(0x0010) (BlueprintVisible, Net, ZeroConstructor)
	TMap<int, struct FSkillDisableKeySet>              DisableSkillTagsMap;                                      // 0x0A20(0x0050) (ZeroConstructor)
	TMap<int, struct FSkillDisableKeySet>              DisableSkillIDsMap;                                       // 0x0A70(0x0050) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnSkillDisableChangeDelegate;                             // 0x0AC0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TMap<int, struct FSkillLimitKeySet>                LimitSkillTagsMap;                                        // 0x0AD0(0x0050) (ZeroConstructor)
	TMap<int, struct FSkillLimitKeySet>                LimitSkillIDMap;                                          // 0x0B20(0x0050) (ZeroConstructor)
	struct FMultiSkillSynData                          NewSkillSynData;                                          // 0x0B70(0x00F0) (BlueprintVisible, Net)
	struct FSkillSinglePhaseData                       NewSkillSinglePhaseData;                                  // 0x0C60(0x00F0) (BlueprintVisible, Net)
	unsigned char                                      UnknownData09[0x8];                                       // 0x0D50(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSkillEventDelegate;                                     // 0x0D58(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TMap<uint64_t, struct FUTSkillSimulateData>        SkillSimulateDataMap;                                     // 0x0D68(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData10[0x50];                                      // 0x0DB8(0x0050) UNKNOWN PROPERTY: SetProperty Skill.UTSkillManagerComponent.AsyncLoadingSkillInst
	struct FUTSkillExecQueue                           SkillExecQueue;                                           // 0x0E08(0x00B0)
	struct FUTSkillEventHistory                        SkillEventHistory;                                        // 0x0EB8(0x0050)
	struct FUTSkillComboState                          SkillComboState;                                          // 0x0F08(0x0018)
	int                                                AsyncSkillComboSkillID;                                   // 0x0F20(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0F24(0x0004) MISSED OFFSET
	uint64_t                                           NetClientSimulateInstID;                                  // 0x0F28(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x10];                                      // 0x0F30(0x0010) MISSED OFFSET
...
{
public:
	TArray<class UUTSkillLocationPickerFilter*>        CheckAdjustFilters;                                       // 0x0078(0x0010) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
...
// Class Skill.UTSkillLocationPickerFilter
// 0x0000 (0x0028 - 0x0028)
class UUTSkillLocationPickerFilter : public UObject
{
public:
	...
	static UClass* StaticClass()
	{
        static UClass *pStaticClass = 0;
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("Class Skill.UTSkillLocationPickerFilter");
		return pStaticClass;
	}


	bool CheckAdjustLocation(const struct FSkillLocationFilterContext& Context, const struct FVector& InLocation, struct FVector* OutLocation);
};
