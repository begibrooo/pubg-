...
// Generate on Tue Sep  8 20:34:36 2026
...
// Enum Engine.EUVStrategy
enum class EUVStrategy : uint8_t
{
	EUVStrategy__Default           = 0,
	EUVStrategy__Conservative      = 1,
	EUVStrategy__Aggressive        = 2,
	EUVStrategy__MultiUV           = 3,
	EUVStrategy__EUVStrategy_MAX   = 4
};
...
// Enum Engine.EPrimitiveVelocityDirection
enum class EPrimitiveVelocityDirection : uint8_t
{
	EPrimitiveVelocityDirection__PVD_None = 0,
	EPrimitiveVelocityDirection__PVD_Outward = 1,
	EPrimitiveVelocityDirection__PVD_Inward = 2,
	EPrimitiveVelocityDirection__PVD_MAX = 3
};
...
// Enum Engine.EParticleCurveParamType
enum class EParticleCurveParamType : uint8_t
{
	PCPT_None                      = 0,
	PCPT_Float                     = 1,
	PCPT_Vector                    = 2,
...
// ScriptStruct Engine.PhysicsDisplayPose
// 0x0030
struct FPhysicsDisplayPose
{
	struct FVector                                     Location;                                                 // 0x0000(0x000C) (Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FQuat                                       Rotation;                                                 // 0x0010(0x0010) (Transient, IsPlainOldData)
	unsigned char                                      bValid : 1;                                               // 0x0020(0x0001) (Transient)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0021(0x000F) MISSED OFFSET
};

// ScriptStruct Engine.PhysicsDisplayPoseHistory
// 0x0070
struct FPhysicsDisplayPoseHistory
{
	struct FPhysicsDisplayPose                         Previous;                                                 // 0x0000(0x0030) (Transient)
	struct FPhysicsDisplayPose                         Current;                                                  // 0x0030(0x0030) (Transient)
	unsigned char                                      bInitialized : 1;                                         // 0x0060(0x0001) (Transient)
	unsigned char                                      bResetRequested : 1;                                      // 0x0060(0x0001) (Transient)
...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData08[0xC];                                       // 0x0124(0x000C) MISSED OFFSET
	struct FPhysicsDisplayPoseHistory                  PhysicsDisplayPoseHistory;                                // 0x0130(0x0070) (Transient)
	unsigned char                                      UnknownData09[0x70];                                      // 0x01A0(0x0070) MISSED OFFSET
};
...
// ScriptStruct Engine.ParticleCurveParam
// 0x0058
struct FParticleCurveParam
{
	struct FName                                       Name;                                                     // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EParticleCurveParamType>               ParamType;                                                // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0009(0x0007) MISSED OFFSET
	struct FInterpCurveFloat                           FloatCurve;                                               // 0x0010(0x0018) (Edit, BlueprintVisible)
	struct FInterpCurveVector                          VectorCurve;                                              // 0x0028(0x0018) (Edit, BlueprintVisible)
	struct FInterpCurveLinearColor                     ColorCurve;                                               // 0x0040(0x0018) (Edit, BlueprintVisible)
};
...
{
	TArray<class UMaterialFunction*>                   Layers;                                                   // 0x0000(0x0010) (Edit, ZeroConstructor)
	TArray<class UMaterialFunction*>                   Blends;                                                   // 0x0010(0x0010) (Edit, ZeroConstructor)
...
struct FHLODProxyMesh
{
	...
	float                                              DrawDistance;                                             // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TLazyObjectPtr<class ALODActor>                    LODActor;                                                 // 0x000C(0x001C) (Edit, EditConst, IsPlainOldData)
...
// ScriptStruct Engine.NetBudgetStageDef
// 0x0018
struct FNetBudgetStageDef
{
	struct FName                                       Name;                                                     // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              Order;                                                    // 0x0008(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Weight;                                                   // 0x000C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              MinRatio;                                                 // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              MaxRatio;                                                 // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FGPUSpriteEmitterInfo
{
	...
	struct FRawDistributionVector                      DynamicColorHDR;                                          // 0x02A8(0x0050)
	struct FRawDistributionFloat                       DynamicAlphaHDR;                                          // 0x02F8(0x0038)
	struct FRawDistributionVector                      DynamicColorScaleHDR;                                     // 0x0330(0x0050)
	struct FRawDistributionFloat                       DynamicAlphaScaleHDR;                                     // 0x0380(0x0038)
...
struct FGPUSpriteResourceData
{
	...
	TArray<struct FColor>                              QuantizedColorSamplesHDR;                                 // 0x0050(0x0010) (ZeroConstructor)
	struct FVector4                                    ColorScaleHDR;                                            // 0x0060(0x0010) (IsPlainOldData)
	struct FVector4                                    ColorBiasHDR;                                             // 0x0070(0x0010) (IsPlainOldData)
	struct FVector4                                    MiscScale;                                                // 0x0080(0x0010) (IsPlainOldData)
	struct FVector4                                    MiscBias;                                                 // 0x0090(0x0010) (IsPlainOldData)
	struct FVector4                                    SimulationAttrCurveScale;                                 // 0x00A0(0x0010) (IsPlainOldData)
	struct FVector4                                    SimulationAttrCurveBias;                                  // 0x00B0(0x0010) (IsPlainOldData)
	struct FVector4                                    SubImageSize;                                             // 0x00C0(0x0010) (IsPlainOldData)
	struct FVector4                                    SizeBySpeed;                                              // 0x00D0(0x0010) (IsPlainOldData)
	struct FVector                                     ConstantAcceleration;                                     // 0x00E0(0x000C) (IsPlainOldData)
	struct FVector                                     OrbitOffsetBase;                                          // 0x00EC(0x000C) (IsPlainOldData)
	struct FVector                                     OrbitOffsetRange;                                         // 0x00F8(0x000C) (IsPlainOldData)
	struct FVector                                     OrbitFrequencyBase;                                       // 0x0104(0x000C) (IsPlainOldData)
	struct FVector                                     OrbitFrequencyRange;                                      // 0x0110(0x000C) (IsPlainOldData)
	struct FVector                                     OrbitPhaseBase;                                           // 0x011C(0x000C) (IsPlainOldData)
	struct FVector                                     OrbitPhaseRange;                                          // 0x0128(0x000C) (IsPlainOldData)
	float                                              GlobalVectorFieldScale;                                   // 0x0134(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              GlobalVectorFieldTightness;                               // 0x0138(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PerParticleVectorFieldScale;                              // 0x013C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PerParticleVectorFieldBias;                               // 0x0140(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DragCoefficientScale;                                     // 0x0144(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DragCoefficientBias;                                      // 0x0148(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ResilienceScale;                                          // 0x014C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ResilienceBias;                                           // 0x0150(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionRadiusScale;                                     // 0x0154(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionRadiusBias;                                      // 0x0158(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionTimeBias;                                        // 0x015C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionRandomSpread;                                    // 0x0160(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CollisionRandomDistribution;                              // 0x0164(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              OneMinusFriction;                                         // 0x0168(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              RotationRateScale;                                        // 0x016C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CameraMotionBlurAmount;                                   // 0x0170(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EParticleScreenAlignment>              ScreenAlignment;                                          // 0x0174(0x0001) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EParticleAxisLock>                     LockAxisFlag;                                             // 0x0175(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0176(0x0002) MISSED OFFSET
	struct FVector2D                                   PivotOffset;                                              // 0x0178(0x0008) (IsPlainOldData)
	unsigned char                                      bRemoveHMDRoll : 1;                                       // 0x0180(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0181(0x0003) MISSED OFFSET
	float                                              MinFacingCameraBlendDistance;                             // 0x0184(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              MaxFacingCameraBlendDistance;                             // 0x0188(0x0004) (ZeroConstructor, IsPlainOldData)
...
struct FMeshMergingSettings
{
	...
	bool                                               bClipUVRegion;                                            // 0x00B1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EUVStrategy                                        UVStrategy;                                               // 0x00B2(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EUVOutput                                          OutputUVs[0x8];                                           // 0x00B3(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
