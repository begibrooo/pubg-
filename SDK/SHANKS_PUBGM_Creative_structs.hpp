...
// Enum Creative.ECreativeTriggerSourceType
enum class ECreativeTriggerSourceType : uint8_t
{
	ECreativeTriggerSourceType__None = 0,
	ECreativeTriggerSourceType__Player = 1,
	ECreativeTriggerSourceType__Robot = 2,
	ECreativeTriggerSourceType__Monster = 3,
	ECreativeTriggerSourceType__Vehicle = 4,
	ECreativeTriggerSourceType__BankProduct = 5,
	ECreativeTriggerSourceType__ECreativeTriggerSourceType_MAX = 6
};
...
// ScriptStruct Creative.BounceMovementSnapshot
// 0x0020
struct FBounceMovementSnapshot
{
	struct FVector                                     Location;                                                 // 0x0000(0x000C) (IsPlainOldData)
	struct FVector                                     Velocity;                                                 // 0x000C(0x000C) (IsPlainOldData)
	uint32_t                                           FrameNumber;                                              // 0x0018(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              ServerTimeStamp;                                          // 0x001C(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
// ScriptStruct Creative.CreativeVFXImageBlendConfig
// 0x0020
struct FCreativeVFXImageBlendConfig
{
	struct FName                                       ImageName;                                                // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x0008(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          AdditiveMaterial;                                         // 0x0010(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DeltaV;                                                   // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Creative.CreativeTriggerSource
// 0x0005
struct FCreativeTriggerSource
{
	bool                                               bPlayer;                                                  // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bRobot;                                                   // 0x0001(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bMonster;                                                 // 0x0002(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVehicle;                                                 // 0x0003(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bBankProduct;                                             // 0x0004(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};

// ScriptStruct Creative.CreativeTriggerActorType
// 0x000C
struct FCreativeTriggerActorType
{
	TWeakObjectPtr<class AActor>                       OverlapActor;                                             // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ECreativeTriggerSourceType                         Type;                                                     // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Creative.CustomAssetRuntimeAnimBoneTranslations
// 0x0010
struct FCustomAssetRuntimeAnimBoneTranslations
{
	TArray<struct FVector>                             Translations;                                             // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
};

// ScriptStruct Creative.CustomAssetRuntimeAnimBoneRotations
// 0x0010
struct FCustomAssetRuntimeAnimBoneRotations
{
	TArray<struct FRotator>                            Rotations;                                                // 0x0000(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
};
...
struct FUGCTimerContext
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	struct FString                                     BlockyId;                                                 // 0x0010(0x0010) (BlueprintVisible, ZeroConstructor)
};
...
struct FDancerDeviceSyncPlayerInfo
{
	...
	uint32_t                                           PlayerUID;                                                // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      PlayerSex;                                                // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	struct FDancerDeviceSyncPlayerAvatarDataInfo       HeadAvatarData;                                           // 0x000C(0x001C)
