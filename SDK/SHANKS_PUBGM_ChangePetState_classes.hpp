...
public:
	...
	TEnumAsByte<EPetState>                             State;                                                    // 0x00A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EPawnStateChangeType>                  ChangeType;                                               // 0x00A9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
