...
public:
	...
	void LoadTemplateToBlockyGraph_Test(TArray<unsigned char> TemplateAst, bool IsCreateNewGraph, bool IsLoadPresetsInGraph);
...
public:
	...
	struct FScriptMulticastDelegate                    OnTextPreCommitted;                                       // 0x0590(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextReceiveCommitted;                                   // 0x05A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	int                                                TextCountLimit;                                           // 0x05B0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SerialId;                                                 // 0x05B4(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               LimitEmojiInput;                                          // 0x05B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsReceiveCheckStringResult;                               // 0x05B9(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
