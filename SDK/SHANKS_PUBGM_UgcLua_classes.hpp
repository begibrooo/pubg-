...
public:
	...
	unsigned char                                      UnknownData06[0xD0];                                      // 0x0198(0x00D0) MISSED OFFSET
	bool                                               bCanFreeze;                                               // 0x0268(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x7];                                       // 0x0269(0x0007) MISSED OFFSET
	struct FScriptDelegate                             AtPanicDelegate;                                          // 0x0270(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnLineCommentDelegate;                                    // 0x0280(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData08[0x10];                                      // 0x0290(0x0010) MISSED OFFSET
	struct FScriptDelegate                             CodeFinishDelegate;                                       // 0x02A0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CodeOutputDelegate;                                       // 0x02B0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             HasEventToRunDelegate;                                    // 0x02C0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             PrepareEventDelegate;                                     // 0x02D0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ExecuteDelayedDelegate;                                   // 0x02E0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CodePreExecuteDelegate;                                   // 0x02F0(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData09[0x20];                                      // 0x0300(0x0020) MISSED OFFSET
	struct FString                                     MainModule;                                               // 0x0320(0x0010) (ZeroConstructor)
	struct FString                                     EventHandlerName;                                         // 0x0330(0x0010) (ZeroConstructor)
	TScriptInterface<class UCreativeEntityInterface>   EntityInterface;                                          // 0x0340(0x0010) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0xF0];                                      // 0x0350(0x00F0) MISSED OFFSET
	...
	int GetUGCLuaBlockMemoryLiveBytes(const struct FString& blockId);
	int GetNowRC();
	int GetMemoryUsed();
	struct FString GetLastCommentInfo();
	void FreezeGameTime(bool bCond);
	void ExtractCurrentCode(int* CodeIdx, struct FString* code);
	bool ExportUGCLuaMemoryProfileAsSluaStat(const struct FString& FilePath, struct FString* outFilePath);
