...
{
public:
	struct FNiagaraUserRedirectionParameterStore       OverrideParameters;                                       // 0x09D0(0x0138) (Edit)
	unsigned char                                      bForceSolo : 1;                                           // 0x0B08(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x24];                                      // 0x0B09(0x0024) MISSED OFFSET
	unsigned char                                      bAutoDestroy : 1;                                         // 0x0B2D(0x0001)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x0B2D(0x0001)
	unsigned char                                      bAutoManageAttachment : 1;                                // 0x0B2D(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0B2E(0x0002) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSystemFinished;                                         // 0x0B30(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TWeakObjectPtr<class USceneComponent>              AutoAttachParent;                                         // 0x0B40(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, DisableEditOnTemplate, EditConst, InstancedReference, IsPlainOldData)
	struct FName                                       AutoAttachSocketName;                                     // 0x0B48(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachLocationRule;                                   // 0x0B50(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachRotationRule;                                   // 0x0B51(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AutoAttachScaleRule;                                      // 0x0B52(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0B53(0x0001) MISSED OFFSET
	int                                                PreviewDetailLevel;                                       // 0x0B54(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	float                                              PreviewLODDistance;                                       // 0x0B58(0x0004) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bEnablePreviewDetailLevel : 1;                            // 0x0B5C(0x0001) (Edit, Transient)
	unsigned char                                      bEnablePreviewLODDistance : 1;                            // 0x0B5C(0x0001) (Edit, Transient)
	unsigned char                                      UnknownData03[0x33];                                      // 0x0B5D(0x0033) MISSED OFFSET
