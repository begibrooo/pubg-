...
void UHiggsBosonComponent::ControlPalmRest(int Switch)
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function HiggsBoson.HiggsBosonComponent.ControlPalmRest");

	UHiggsBosonComponent_ControlPalmRest_Params params;
	params.Switch = Switch;
