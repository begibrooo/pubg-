...
// Function Common_DragDrop_Item.Common_DragDrop_Item_C.OnTestDragLeave__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UCommon_DragDrop_Item_C::OnTestDragLeave__DelegateSignature()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Common_DragDrop_Item.Common_DragDrop_Item_C.OnTestDragLeave__DelegateSignature");

	UCommon_DragDrop_Item_C_OnTestDragLeave__DelegateSignature_Params params;
...
// Function Common_DragDrop_Item.Common_DragDrop_Item_C.OnTestDragEnter__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UCommon_DragDrop_Item_C::OnTestDragEnter__DelegateSignature()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Common_DragDrop_Item.Common_DragDrop_Item_C.OnTestDragEnter__DelegateSignature");

	UCommon_DragDrop_Item_C_OnTestDragEnter__DelegateSignature_Params params;
