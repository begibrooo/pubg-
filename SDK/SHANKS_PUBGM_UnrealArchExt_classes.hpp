...
public:
	...
	struct FScriptMulticastDelegate                    OnPostWorldCleanupEvent;                                  // 0x0208(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UWorld*                                      CurrentGameStatusWorld;                                   // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x10];                                      // 0x0220(0x0010) MISSED OFFSET
